...
class Ra extends Model
{
    ...
    {
        return $this->hasMany('App\Activitat', 'ra_ids', 'id');
    }
    ...
    {
        return $this->hasMany('App\ActivitatRa', 'ra_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Contingut', 'ra_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Criteri', 'ra_id', 'id');
    }
